...
(function() {
	goog.provide('injector.gn_usergroup_controller');

	var module = angular.module('injector.gn_usergroup_controller', []);
		...
		.push(function() {
			JsUtil
					.appendHtmlContentIntoElement(
							$(document.body),
							'/geonetwork/catalog/components/openwis-extensions/gn_usergroup_controller/script.gn_usergroup_controller.html');
		});
