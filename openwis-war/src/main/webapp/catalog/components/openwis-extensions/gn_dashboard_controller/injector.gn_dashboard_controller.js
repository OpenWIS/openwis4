...
(function() {
	goog.provide('injector.gn_dashboard_controller');

	var module = angular.module('injector.gn_dashboard_controller', []);
...
.push(function() {
	JsUtil
			.appendHtmlContentIntoElement(
					$(document.body),
					'/geonetwork/catalog/components/openwis-extensions/gn_dashboard_controller/script.gn_dashboard_controller.html');
});
